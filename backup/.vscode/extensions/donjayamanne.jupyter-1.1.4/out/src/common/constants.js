...
(function (Commands) {
    ...
    (function (Jupyter) {
        ...
        Jupyter.StartNotebook = 'jupyter.startNotebook';
        Jupyter.SelectExistingNotebook = 'jupyter.selectExistingNotebook';
        Jupyter.ProvideNotebookDetails = 'jupyter.provideNotebookDetails';
