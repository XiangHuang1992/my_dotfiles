...
let UiService = class UiService {
    ...
    getWorkspaceFolder(uri) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gitService = yield this.serviceContainer.get(types_4.IGitServiceFactory).createGitService(firstWorkspaceFolder, firstWorkspaceFolder);
            const gitRoots = yield gitService.getGitRoots(workspaceFolder);
