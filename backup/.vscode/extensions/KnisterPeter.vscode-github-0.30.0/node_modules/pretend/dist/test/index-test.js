...
ava_1.default('Pretend should call a post method with FormData', function (t) {
    var test = setup();
    nock('http://host:port/', {
        reqheaders: {
...
ava_1.default('Pretend should call a post method with FormData and query', function (t) {
    var test = setup();
    nock('http://host:port/', {
        reqheaders: {
            'Content-Type': /^multipart\/form-data/
...
ava_1.default('Pretend should call a post method with empty FormData and query', function (t) {
    var test = setup();
    nock('http://host:port/', {
        reqheaders: {
            'Content-Type': /^multipart\/form-data/
...
ava_1.default('Pretend should call a delete method and append query parameters', function (t) {
    var test = setup();
