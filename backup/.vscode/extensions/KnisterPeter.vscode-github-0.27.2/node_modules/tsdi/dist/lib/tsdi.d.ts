...
export declare class TSDI {
    ...
    close(): void;
    private destroyInstance(idx, metadata);
    ...
    private throwComponentNotFoundError(component?, name?, additionalInfo?);
    private getConstructorParameters(metadata);
    private isSingleton(metadata);
    private getOrCreate<T>(metadata, idx);
    private createComponent<T>(metadata, idx);
    private hasEnteredScope(metadata);
    configureExternal<T>(args: any[], target: any): T;
    private injectIntoInstance(instance, externalInstance, componentMetadata);
    private injectDependency(instance, externalInstance, inject, componentMetadata);
    ...
    private getComponentDependency(inject, dependentMetadata, noScopeWarning);
