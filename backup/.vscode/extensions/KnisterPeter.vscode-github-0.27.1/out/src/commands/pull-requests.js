...
let CreatePullRequest = class CreatePullRequest extends PullRequestCommand {
    ...
    getRepository(uri) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield vscode.window.showQuickPick(items, { placeHolder: 'Select a repository to create the pull request in' });
        });
    }
    getTargetBranch(defaultBranch, uri) {
        return __awaiter(this, void 0, void 0, function* () {
            // sort default branch up
            const picks = (yield this.git.getRemoteBranches(uri))
                .sort((b1, b2) => {
                if (b1 === defaultBranch) {
                    return -1;
                }
