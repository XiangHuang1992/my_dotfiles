...
let StatusBarManager = class StatusBarManager {
    get customStatusBarCommand() {
        ...
        return helper_1.getConfiguration('github', uri).statusBarCommand || helper_1.getConfiguration('github', uri).statusbar.command;
    }
    get refreshInterval() {
    ...
    refreshStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const uri = this.getActiveWorkspaceFolder();
                if (uri && (yield this.workflowManager.canConnect(uri))) {
